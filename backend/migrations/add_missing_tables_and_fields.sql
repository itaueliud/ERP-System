...
-- ============================================================================
-- Ensure expense_reports table exists with correct schema
-- ============================================================================
...
CREATE INDEX IF NOT EXISTS idx_expense_reports_requester_id ON expense_reports(requester_id);
CREATE INDEX IF NOT EXISTS idx_expense_reports_status ON expense_reports(status);
CREATE INDEX IF NOT EXISTS idx_expense_reports_reviewed_by ON expense_reports(reviewed_by);
CREATE INDEX IF NOT EXISTS idx_expense_reports_created_at ON expense_reports(created_at);
