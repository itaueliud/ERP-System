...
// Daraja webhook — must be PUBLIC (no JWT) and reachable at the exact URL sent to Safaricom
...
app.use('/api/v1/developer-teams', authenticate, developerTeamRoutes);
app.use('/api/v1/staff-payments', authenticate, staffPaymentRoutes);
