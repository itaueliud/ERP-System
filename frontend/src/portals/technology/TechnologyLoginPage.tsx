...
const ALLOWED_ROLES = ['TECHNOLOGY_USER', 'DEVELOPER', 'CTO'];
const theme = PORTAL_THEMES.technology;
const DEV_CREDS = [{ label: "Tech Lead", email: "tech@tst.com", password: "Tech@12345678!" }, { label: "Developer", email: "dev@tst.com", password: "Dev@123456789!" }];
    ...
    <div className="min-h-screen flex" style={{ background: `linear-gradient(135deg, ${theme.hex}15 0%, #f8fafc 100%)` }}>
      <div className="hidden lg:flex lg:w-5/12 flex-col items-center justify-center p-12 text-white relative overflow-hidden"
        ...
        <div className="relative text-center max-w-xs">
          ...
          <p className="text-white/50 text-sm leading-relaxed">Projects, GitHub integration &amp; developer metrics</p>
        </div>
      </div>
